...
import { getCourses, getCoursesbyId, addCourses, getBatches, addBatch, getBatchById, deleteCourseById,getfullBatches } from '../service/courseService';
...
route.get('/batches', (req, res) => {
    ...
    getfullBatches().then((batch: BatchI[] | null) => {
